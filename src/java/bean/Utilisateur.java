...
public class Utilisateur implements Serializable {
    ...
    public Utilisateur(String nom, String prenom, int profile, String email, String password) {
        this.nom = nom;
        this.prenom = prenom;
    ...
    public int getEtatProfile() {
        return etatProfile;
    }

    public void setEtatProfile(int etatProfile) {
        this.etatProfile = etatProfile;
    }
